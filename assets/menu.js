...
(function () {
  ...
  var I = {
    ...
    toolbox: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"><polygon points="12,2.4 20.4,7.2 20.4,16.8 12,21.6 3.6,16.8 3.6,7.2"/><circle cx="12" cy="12" r="4"/></svg>',
  ...
  var LINKS = [
    ...
    { key: "calc",     label: "Render Calculators",    href: u("calculators/index.html"),                    icon: I.calc },
    { key: "toolbox",  label: "TOOLBOX",               href: "https://technicallytechnicaldesign.github.io/TOOLBOX/", icon: I.toolbox, external: true },
