...
Process material (pickup notes, inventory/backlog, research, the test ladder
and bench sheet) lives in the private RENKON_LAB repo, not here.

## Current scripts (`scripts/`)

| Script | Stage | What it does |
|---|---|---|
| [`0_VAL_STEP_PREFLIGHT_AA02.py`](scripts/0_VAL_STEP_PREFLIGHT_AA02.py) | 0 &middot; VAL | STEP-file preflight — unit/scale, filename hygiene, duplicates, material-name hints |
| [`0_VAL_IMPORT_HEALTH_AA02.py`](scripts/0_VAL_IMPORT_HEALTH_AA02.py) | 0 &middot; VAL | Trial-import geometry/appearance health check before a full batch commit |
...
| [`2b_ANI_CUTAWAY_REVEAL_AA02.py`](scripts/2b_ANI_CUTAWAY_REVEAL_AA02.py) | 2b &middot; ANI | Cutaway / cross-section reveal, sweeps a clip plane through an assembly |
| [`2b_ANI_ASSEMBLY_PROCEDURAL_AA02.py`](scripts/2b_ANI_ASSEMBLY_PROCEDURAL_AA02.py) | 2b &middot; ANI | Procedural assembly reveal — scatter/settle, staggered build, spiral converge, ghost fade |
| [`3_PRC_CONTACT_SHEET_AA02.py`](scripts/3_PRC_CONTACT_SHEET_AA02.py) | 3 &middot; PRC | Standalone HTML contact sheet from a batch's rendered output |
| [`3_PRC_FADE_REEL_AA02.py`](scripts/3_PRC_FADE_REEL_AA02.py) | 3 &middot; PRC | Multi-angle crossfade reel between Studio/camera stills, pure CSS, no dependencies |
| [`4_CHK_AUDIT_AA02.py`](scripts/4_CHK_AUDIT_AA02.py) | 4 &middot; CHK | Naming-compliance + render-completeness audit |
