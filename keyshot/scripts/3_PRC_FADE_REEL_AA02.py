...
# Python interpreter after a batch render (2a_BAT_STD_VIEW_AA02.py) or
# turntable run (2a_BAT_TURNTABLE_AA02.py). It scans an output folder for
...
#
# Per the Creo/KeyShot research (RENKON_LAB): crossfading is 2D compositing, not a render
...
#
# Usage:
#   python 3_PRC_FADE_REEL_AA02.py /path/to/output/folder
