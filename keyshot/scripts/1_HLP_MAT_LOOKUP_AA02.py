...
# scene-wide. `1_HLP_MAT_PREFLIGHT_AA02.py` catches the SYMPTOM of missing
...
# -----------------------------------------------------------------------
# Confirmed (used the same way in 1_HLP_MAT_PREFLIGHT_AA02.py and
# 2a_BAT_STD_VIEW_AA02.py already in this pipeline): lux.newScene(),
...
# 2b_ANI_HERO_REVEAL_AA02.py. If none of them exist on your KeyShot
...
def collectObjectNodes(node, results=None):
    ...
    # 1_HLP_MAT_PREFLIGHT_AA02.py, but keeps the node reference itself
...
def main():
    ...
    print("Unmapped-material count above is the complementary read to what "
          "1_HLP_MAT_PREFLIGHT_AA02.py reports: preflight flags objects whose material didn't change "
