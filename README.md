...
| [`keyshot/`](keyshot/) | KeyShot automation: `lux` scripts, hub + filterable script inventory, backplate-creator. | Live |
| [`mockup-studio/`](mockup-studio/) | Product mockup compositor: procedural scenes, motion overlays, WebM export. | Live |
| [`calculators/`](calculators/) | Render-domain calculators (time/quality, electricity cost, frame rates). | Live |
